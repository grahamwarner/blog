...
In order to predict if or when your ferry is going to be full, we need to collect data on how full ferries typically are over time. My next post will be about how I recorded this data.
